...
export default function PatientData(props) {
  ...
  return (
    <>
 <View style={{backgroundColor:'rgba(173, 216, 230,0.5)',width:400,height:350,padding:20,marginBottom:50}}>
    <View style={styles.image}>  
  <Image style={styles.img} source={require(`../assets/categ/person.jpg`)}/>
</View>

    <View style={styles.square}>
    <Text style={{justifyContent:'center',fontSize:25,color:'white',fontWeight:'bold',marginBottom:20}}> بيانات المريض الشخصية:</Text>    
