...
useEffect(()=>{Pat_His()},[])
  ...
  return (
    ...
    <View style={{backgroundColor:'rgba(173, 216, 230,0.5)',width:400,height:550,padding:20}}>
    <View style={styles.image}>  
  <Image style={styles.img} source={require(`../assets/categ/person.jpg`)}/>
</View>

    <View style={styles.square}>
    <Text style={{justifyContent:'center',fontSize:25,color:'white',fontWeight:'bolder',marginBottom:20}}> بيانات المريض الشخصية:</Text>    
...
<Table >
    <Row borderStyle={{borderWidth: 0, borderColor: '#251e51'}} data={[ 'تاريخ الدخول', 'الاسم المتدرب على نطقه', 'مستوى التقدم']} style={styles.head} textStyle={styles.text}/>
...
const styles = StyleSheet.create({
    ...
    buttonTextStyle: {
      ...
      head: { height: 40,marginTop:50 },
      text: { margin: 6 ,color:'orange',fontSize:20,fontWeight:'bold',textAlign:'center'}
